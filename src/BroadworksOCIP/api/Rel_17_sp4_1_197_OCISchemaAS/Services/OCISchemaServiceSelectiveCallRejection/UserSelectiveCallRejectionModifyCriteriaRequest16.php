...
use BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\Services\OCISchemaServiceSelectiveCallRejection\SelectiveCallRejectionCriteriaCallTypeModify;
...
{
    public    $elementName = 'UserSelectiveCallRejectionModifyCriteriaRequest16';
    protected $userId;
    ...
    {
        $this->fromDnCriteria = ($fromDnCriteria InstanceOf SelectiveCallRejectionCriteriaCallTypeModify)
             ? $fromDnCriteria
             : new SelectiveCallRejectionCriteriaCallTypeModify($fromDnCriteria);
    ...
    /**
     * 
     * @return SelectiveCallRejectionCriteriaCallTypeModify $fromDnCriteria
     */
