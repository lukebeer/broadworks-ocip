...
use BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\Services\OCISchemaServiceLDAPIntegration\GroupLDAPIntegrationLevel;
...
{
    public    $elementName = 'GroupLDAPIntegrationModifyDirectoryRequest';
    ...
    public function __construct(
        ...
        $this->setAuthenticatedDN($authenticatedDN);
        $this->setAuthenticatedPassword($authenticatedPassword);
        $this->setIsSortEnabled($isSortEnabled);
        $this->setIsPagedResultEnabled($isPagedResultEnabled);
        $this->setSearchFilter($searchFilter);
        $this->setIncludeSearchAttributeInSearchFilter($includeSearchAttributeInSearchFilter);
        $this->setColumn1AttributeName($column1AttributeName);
        $this->setColumn2AttributeName($column2AttributeName);
        $this->setColumn3AttributeName($column3AttributeName);
        $this->setColumn4AttributeName($column4AttributeName);
        $this->setColumn1Label($column1Label);
        $this->setColumn2Label($column2Label);
    ...
    public function setUseLevel($useLevel = null)
    {
        ...
        $this->useLevel->setElementName('useLevel');
        return $this;
    }
