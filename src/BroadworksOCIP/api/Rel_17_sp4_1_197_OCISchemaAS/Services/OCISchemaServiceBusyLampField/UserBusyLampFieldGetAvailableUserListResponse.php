...
{
    public    $elementName = 'UserBusyLampFieldGetAvailableUserListResponse';
    protected $userTable;

    /**
     * @return \BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\Services\OCISchemaServiceBusyLampField\UserBusyLampFieldGetAvailableUserListResponse $response
     */
