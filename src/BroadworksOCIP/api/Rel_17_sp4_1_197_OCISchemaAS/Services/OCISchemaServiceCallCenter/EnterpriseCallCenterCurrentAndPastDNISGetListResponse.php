...
{
    public    $elementName = 'EnterpriseCallCenterCurrentAndPastDNISGetListResponse';
    protected $name;
    protected $deletedName;

    /**
     * @return \BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\Services\OCISchemaServiceCallCenter\EnterpriseCallCenterCurrentAndPastDNISGetListResponse $response
     */
