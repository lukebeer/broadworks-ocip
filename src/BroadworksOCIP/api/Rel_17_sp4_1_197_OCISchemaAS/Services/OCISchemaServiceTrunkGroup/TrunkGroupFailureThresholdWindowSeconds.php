 ...
 */
class TrunkGroupFailureThresholdWindowSeconds extends SimpleType
{
    public $elementName = "TrunkGroupFailureThresholdWindowSeconds";
    public function __construct($value) {
        $this->setElementValue($value);
        $this->addRestriction(new MinInclusive("30"));
        $this->addRestriction(new MaxInclusive("240"));
    }
}
