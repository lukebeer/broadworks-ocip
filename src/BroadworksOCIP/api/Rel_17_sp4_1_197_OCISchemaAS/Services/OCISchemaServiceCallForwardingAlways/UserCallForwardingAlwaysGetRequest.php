...
{
    public    $responseType = 'BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\Services\OCISchemaServiceCallForwardingAlways\UserCallForwardingAlwaysGetResponse';
    public    $elementName = 'UserCallForwardingAlwaysGetRequest';
    protected $userId;
