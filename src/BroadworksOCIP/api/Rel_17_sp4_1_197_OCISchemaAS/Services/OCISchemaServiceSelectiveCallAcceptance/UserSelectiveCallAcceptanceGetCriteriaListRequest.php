 ...
 */
class UserSelectiveCallAcceptanceGetCriteriaListRequest extends ComplexType implements ComplexInterface
{
    public    $responseType = 'BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\Services\OCISchemaServiceSelectiveCallAcceptance\UserSelectiveCallAcceptanceGetCriteriaListResponse';
    public    $elementName = 'UserSelectiveCallAcceptanceGetCriteriaListRequest';
    protected $userId;
