...
{
    public    $responseType = 'BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDeprecated14\UserSimultaneousRingFamilyGetResponse';
    public    $elementName = 'UserSimultaneousRingFamilyGetRequest';
    protected $userId;
