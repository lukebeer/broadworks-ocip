 ...
 */
class ServiceProviderCallProcessingGetPolicyResponse14sp1 extends ComplexType implements ComplexInterface
{
    public    $elementName = 'ServiceProviderCallProcessingGetPolicyResponse14sp1';
