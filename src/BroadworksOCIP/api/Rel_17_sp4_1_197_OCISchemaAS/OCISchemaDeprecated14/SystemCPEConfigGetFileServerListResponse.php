...
{
    public    $elementName = 'SystemCPEConfigGetFileServerListResponse';
    protected $fileServerTable;

    /**
     * @return \BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDeprecated14\SystemCPEConfigGetFileServerListResponse $response
     */
