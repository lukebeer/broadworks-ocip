 ...
 */
class UserSequentialRingGetRequest13mp16 extends ComplexType implements ComplexInterface
{
    public    $responseType = 'BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDeprecated14\UserSequentialRingGetResponse13mp16';
    public    $elementName = 'UserSequentialRingGetRequest13mp16';
    protected $userId;
