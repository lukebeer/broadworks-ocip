...
{
    public    $elementName = 'GroupPortalPasscodeRulesGetResponse';
    ...
    /**
     * @return \BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaGroup\GroupPortalPasscodeRulesGetResponse $response
     */
