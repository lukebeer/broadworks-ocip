...
{
    public    $elementName = 'GroupCustomContactDirectoryGetResponse17';
    protected $userTable;

    /**
     * @return \BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaGroup\GroupCustomContactDirectoryGetResponse17 $response
     */
