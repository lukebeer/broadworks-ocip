 ...
 */
class UserSelectiveCallAcceptanceGetCriteriaResponse extends ComplexType implements ComplexInterface
{
    public    $elementName = 'UserSelectiveCallAcceptanceGetCriteriaResponse';
