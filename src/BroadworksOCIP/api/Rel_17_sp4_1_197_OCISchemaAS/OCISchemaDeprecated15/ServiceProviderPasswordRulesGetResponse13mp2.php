...
{
    public    $elementName = 'ServiceProviderPasswordRulesGetResponse13mp2';
    ...
    /**
     * @return \BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDeprecated15\ServiceProviderPasswordRulesGetResponse13mp2 $response
     */
