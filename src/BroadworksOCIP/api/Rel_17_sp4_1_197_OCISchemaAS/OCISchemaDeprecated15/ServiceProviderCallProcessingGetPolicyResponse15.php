 ...
 */
class ServiceProviderCallProcessingGetPolicyResponse15 extends ComplexType implements ComplexInterface
{
    public    $elementName = 'ServiceProviderCallProcessingGetPolicyResponse15';
