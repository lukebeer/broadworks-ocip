...
{
    public    $elementName = 'ServiceProviderAccessDeviceFileGetResponse14sp8';
    protected $fileSource;
    protected $configurationFileName;

    /**
     * @return \BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDeprecated16\ServiceProviderAccessDeviceFileGetResponse14sp8 $response
     */
