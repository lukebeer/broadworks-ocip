...
{
    public    $responseType = 'BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDeprecated16\UserTimeScheduleGetListResponse';
    public    $elementName = 'UserTimeScheduleGetListRequest';
    protected $userId;
