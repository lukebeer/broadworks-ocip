...
{
    public    $elementName = 'SystemAccessDeviceMonitorGetDeviceTypeListResponse';
    protected $deviceType;

    /**
     * @return \BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaSystem\SystemAccessDeviceMonitorGetDeviceTypeListResponse $response
     */
