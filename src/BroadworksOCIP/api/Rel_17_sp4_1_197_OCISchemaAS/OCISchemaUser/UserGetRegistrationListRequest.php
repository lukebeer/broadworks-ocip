 ...
 */
class UserGetRegistrationListRequest extends ComplexType implements ComplexInterface
{
    public    $responseType = 'BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaUser\UserGetRegistrationListResponse';
    public    $elementName = 'UserGetRegistrationListRequest';
    protected $userId;
