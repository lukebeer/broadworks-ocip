...
use BroadworksOCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\RegistrationAddressURI;
...
{
    public    $elementName = 'SearchCriteriaRegistrationURI';
    protected $mode;
    protected $value;
    ...
    /**
     * 
     * @return RegistrationAddressURI $value
     */
