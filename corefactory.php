...
class CoreFactory {
    ...
    public static function getOCIClient($url=null, $autoLogout=true, $followRedirects=true, $proxy=null) {
        require_once(OCI_PATH . "/core/OCIClient.php");
        $instance = new OCIClient($url, $autoLogout, $followRedirects, $proxy);
        return $instance;
    }
