 ...
 */
class UserGetResponse17sp4 extends ComplexType implements ComplexInterface
{
    public    $name = 'UserGetResponse17sp4';
    ...
    {
        return ($this->primaryZoneName) ? $this->primaryZoneName->getValue() : null;
    }
}
