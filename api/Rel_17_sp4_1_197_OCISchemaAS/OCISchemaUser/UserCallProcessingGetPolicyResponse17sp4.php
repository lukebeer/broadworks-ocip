 ...
 */
class UserCallProcessingGetPolicyResponse17sp4 extends ComplexType implements ComplexInterface
{
    public    $name = 'UserCallProcessingGetPolicyResponse17sp4';
    protected $useUserCLIDSetting;
    protected $useUserMediaSetting;
    protected $useUserCallLimitsSetting;
    protected $useUserDCLIDSetting;
    ...
    /**
     * @return \Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaUser\UserCallProcessingGetPolicyResponse17sp4 $response
     */
    ...
    /**
     * 
     * @return boolean $useUserDCLIDSetting
     */
    public function getUseUserDCLIDSetting()
    {
        return ($this->useUserDCLIDSetting) ? $this->useUserDCLIDSetting->getValue() : null;
    }
    ...
    {
        return ($this->allowConfigurableCLIDForRedirectingIdentity) ? $this->allowConfigurableCLIDForRedirectingIdentity->getValue() : null;
    }
}
