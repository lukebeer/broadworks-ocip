 ...
 */
class UserNetworkConferencingGetRequest extends ComplexType implements ComplexInterface
{
    public    $responseType = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaUser\UserNetworkConferencingGetResponse';
    public    $elementName = 'UserNetworkConferencingGetRequest';
    protected $userId;
