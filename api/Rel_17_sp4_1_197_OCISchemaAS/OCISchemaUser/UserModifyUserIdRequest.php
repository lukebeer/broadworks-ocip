...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaUser\UserModifyUserIdResponse;
...
class UserModifyUserIdRequest extends ComplexType implements ComplexInterface
{
    ...
    /**
     * @return UserModifyUserIdResponse
     */
    ...
    {
        return (!$this->newUserId) ?: $this->newUserId->getValue();
    }
}
