...
{
    const     RESPONSE_TYPE       = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDeprecated14\UserSimultaneousRingPersonalGetResponse';
    ...
    {
        return (!$this->simRingPhoneNumber) ?: $this->simRingPhoneNumber->getValue();
    }
}
