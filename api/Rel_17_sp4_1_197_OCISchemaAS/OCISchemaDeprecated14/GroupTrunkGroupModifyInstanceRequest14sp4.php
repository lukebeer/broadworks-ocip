...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDeprecated14\GroupTrunkGroupModifyInstanceResponse14sp4;
...
class GroupTrunkGroupModifyInstanceRequest14sp4 extends ComplexType implements ComplexInterface
{
    ...
    /**
     * @return GroupTrunkGroupModifyInstanceResponse14sp4
     */
    ...
    {
        return (!$this->hostedUserIdList) ?: $this->hostedUserIdList->getValue();
    }
    ...
    {
        $this->usePilotUserCallingLineIdentity = (boolean) $usePilotUserCallingLineIdentity;
    }
    ...
    {
        $this->usePilotUserChargeNumber = (boolean) $usePilotUserChargeNumber;
    }
