 ...
 */
class UserCallTransferGetRequest extends ComplexType implements ComplexInterface
{
    public    $responseType = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDeprecated14\UserCallTransferGetResponse';
    public    $elementName = 'UserCallTransferGetRequest';
    protected $userId;
