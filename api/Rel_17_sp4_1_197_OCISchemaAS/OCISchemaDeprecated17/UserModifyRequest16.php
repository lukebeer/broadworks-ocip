 ...
 */
class UserModifyRequest16 extends ComplexType implements ComplexInterface
{
    public    $name = 'UserModifyRequest16';
    protected $userId;
    protected $lastName;
    protected $firstName;
    ...
    {
        return ($this->endpoint) ? $this->endpoint->getValue() : null;
    }
