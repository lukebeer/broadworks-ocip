 ...
 */
class GroupCallProcessingModifyPolicyRequest15sp2 extends ComplexType implements ComplexInterface
{
    public    $name = 'GroupCallProcessingModifyPolicyRequest15sp2';
    ...
    public function __construct(
        ...
        $this->setUseGroupDCLIDSetting($useGroupDCLIDSetting);
    ...
    public function setUseGroupDCLIDSetting($useGroupDCLIDSetting = null)
    {
        ...
        $this->useGroupDCLIDSetting->setName('useGroupDCLIDSetting');
        return $this;
    }
    ...
    {
        return ($this->useGroupDCLIDSetting) ? $this->useGroupDCLIDSetting->getValue() : null;
    }
