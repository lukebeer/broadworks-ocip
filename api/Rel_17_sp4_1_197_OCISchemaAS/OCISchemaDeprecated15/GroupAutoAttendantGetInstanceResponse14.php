...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\AutoAttendantReadMenu;
...
class GroupAutoAttendantGetInstanceResponse14 extends ComplexType implements ComplexInterface
{
    ...
    {
        $businessHoursMenu and $this->businessHoursMenu = new AutoAttendantReadMenu($businessHoursMenu);
    }
    ...
    {
        $afterHoursMenu and $this->afterHoursMenu = new AutoAttendantReadMenu($afterHoursMenu);
    }
