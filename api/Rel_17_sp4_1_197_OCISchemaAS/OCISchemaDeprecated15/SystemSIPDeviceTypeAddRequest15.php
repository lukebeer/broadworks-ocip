...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\CPEDeviceOptions14sp6;
...
class SystemSIPDeviceTypeAddRequest15 extends ComplexType implements ComplexInterface
{
    ...
    {
        $cpeDeviceOptions and $this->cpeDeviceOptions = new CPEDeviceOptions14sp6($cpeDeviceOptions);
    }
