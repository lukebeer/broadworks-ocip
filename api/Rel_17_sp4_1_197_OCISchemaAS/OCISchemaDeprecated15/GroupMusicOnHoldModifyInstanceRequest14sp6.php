...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\MusicOnHoldSourceModify;
...
class GroupMusicOnHoldModifyInstanceRequest14sp6 extends ComplexType implements ComplexInterface
{
    ...
    {
        $source and $this->source = new MusicOnHoldSourceModify($source);
    }
    ...
    {
        $internalSource and $this->internalSource = new MusicOnHoldSourceModify($internalSource);
    }
