...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\SequentialRingLocation14sp4;
...
class UserSequentialRingGetResponse14sp4 extends ComplexType implements ComplexInterface
{
    ...
    {
        $Location01 and $this->Location01 = new SequentialRingLocation14sp4($Location01);
    }
    ...
    {
        $Location02 and $this->Location02 = new SequentialRingLocation14sp4($Location02);
    }
    ...
    {
        $Location03 and $this->Location03 = new SequentialRingLocation14sp4($Location03);
    }
    ...
    {
        $Location04 and $this->Location04 = new SequentialRingLocation14sp4($Location04);
    }
    ...
    {
        $Location05 and $this->Location05 = new SequentialRingLocation14sp4($Location05);
    }
