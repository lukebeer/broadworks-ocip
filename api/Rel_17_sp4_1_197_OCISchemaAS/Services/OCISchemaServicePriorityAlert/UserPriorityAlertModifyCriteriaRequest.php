...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\PriorityAlertCriteriaFromDnModify;
...
class UserPriorityAlertModifyCriteriaRequest extends ComplexType implements ComplexInterface
{
    ...
    {
        $fromDnCriteria and $this->fromDnCriteria = new PriorityAlertCriteriaFromDnModify($fromDnCriteria);
    }
