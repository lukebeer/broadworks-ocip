...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\OutgoingPinholeDigitPlanDigitPatternOriginatingDepartmentPermissionsModify;
...
class GroupOutgoingCallingPlanPinholeDigitPlanOriginatingModifyListRequest extends ComplexType implements ComplexInterface
{
    ...
    {
        $groupPermissions and $this->groupPermissions = new OutgoingPinholeDigitPlanDigitPatternOriginatingPermissions($groupPermissions);
    }
    ...
    {
        $departmentPermissions and $this->departmentPermissions = new OutgoingPinholeDigitPlanDigitPatternOriginatingDepartmentPermissionsModify($departmentPermissions);
    }
