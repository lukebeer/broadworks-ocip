...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\OutgoingCallingPlanDigitPatternRedirectingDepartmentPermissionsModify;
...
class GroupOutgoingCallingPlanDigitPlanRedirectingModifyListRequest extends ComplexType implements ComplexInterface
{
    ...
    {
        $departmentPermissions and $this->departmentPermissions = new OutgoingCallingPlanDigitPatternRedirectingDepartmentPermissionsModify($departmentPermissions);
    }
