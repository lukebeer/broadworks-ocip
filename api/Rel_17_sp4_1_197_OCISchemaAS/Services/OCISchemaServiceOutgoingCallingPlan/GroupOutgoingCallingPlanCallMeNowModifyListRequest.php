...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\OutgoingCallingPlanCallMeNowDepartmentPermissionsModify;
...
class GroupOutgoingCallingPlanCallMeNowModifyListRequest extends ComplexType implements ComplexInterface
{
    ...
    {
        $groupPermissions and $this->groupPermissions = new OutgoingCallingPlanCallMeNowPermissionsModify($groupPermissions);
    }
    ...
    {
        $departmentPermissions and $this->departmentPermissions = new OutgoingCallingPlanCallMeNowDepartmentPermissionsModify($departmentPermissions);
    }
