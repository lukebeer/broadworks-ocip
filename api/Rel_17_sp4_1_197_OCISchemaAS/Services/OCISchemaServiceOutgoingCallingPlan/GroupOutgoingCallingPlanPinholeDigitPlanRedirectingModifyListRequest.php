...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\OutgoingPinholeDigitPlanDigitPatternRedirectingDepartmentPermissionsModify;
...
class GroupOutgoingCallingPlanPinholeDigitPlanRedirectingModifyListRequest extends ComplexType implements ComplexInterface
{
    ...
    {
        $departmentPermissions and $this->departmentPermissions = new OutgoingPinholeDigitPlanDigitPatternRedirectingDepartmentPermissionsModify($departmentPermissions);
    }
