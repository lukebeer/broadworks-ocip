...
{
    public    $name              = 'UserOutgoingCallingPlanPinholeDigitPlanRedirectingModifyRequest';
    ...
    public function __construct(
         ...
         OutgoingPinholeDigitPlanDigitPatternRedirectingPermissions $userPermissions = null
    ) {
