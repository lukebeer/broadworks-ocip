...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\OutgoingPinholeDigitPlanDigitPatternCallMeNowDepartmentPermissionsModify;
...
class GroupOutgoingCallingPlanPinholeDigitPlanCallMeNowModifyListRequest extends ComplexType implements ComplexInterface
{
    ...
    {
        $departmentPermissions and $this->departmentPermissions = new OutgoingPinholeDigitPlanDigitPatternCallMeNowDepartmentPermissionsModify($departmentPermissions);
    }
