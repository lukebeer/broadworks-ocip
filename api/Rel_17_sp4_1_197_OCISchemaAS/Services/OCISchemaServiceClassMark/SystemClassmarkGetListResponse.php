...
{
    const     RESPONSE_TYPE   = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaServiceClassMark\SystemClassmarkGetListResponse';
    ...
    {
        $this->classmarkTable = core:OCITable $classmarkTable;
    }
