 ...
 */
class InstantConferencingRecurrenceWeekInterval extends SimpleType
{
    public $elementName = "InstantConferencingRecurrenceWeekInterval";
    public function __construct($value) {
        $this->setElementValue($value);
        $this->addRestriction(new MinInclusive("1"));
        $this->addRestriction(new MaxInclusive("53"));
    }
}
