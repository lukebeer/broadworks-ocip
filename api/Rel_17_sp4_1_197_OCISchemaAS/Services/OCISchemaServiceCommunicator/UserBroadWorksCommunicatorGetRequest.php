...
{
    public    $responseType = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\Services\OCISchemaServiceCommunicator\UserBroadWorksCommunicatorGetResponse';
    public    $elementName = 'UserBroadWorksCommunicatorGetRequest';
    protected $userId;
