...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\MusicOnHoldUserSourceModify16;
...
class UserMusicOnHoldUserModifyRequest16 extends ComplexType implements ComplexInterface
{
    ...
    {
        $source and $this->source = new MusicOnHoldUserSourceModify16($source);
    }
    ...
    {
        $internalSource and $this->internalSource = new MusicOnHoldUserSourceModify16($internalSource);
    }
