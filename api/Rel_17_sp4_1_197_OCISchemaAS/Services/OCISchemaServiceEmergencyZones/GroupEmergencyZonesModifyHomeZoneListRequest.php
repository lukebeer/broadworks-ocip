...
class GroupEmergencyZonesModifyHomeZoneListRequest extends ComplexType implements ComplexInterface
{
    ...
    {
        $homeZoneIpAddressList and $this->homeZoneIpAddressList = new ($homeZoneIpAddressList);
    }
    ...
    {
        $homeZoneIpAddressRangeList and $this->homeZoneIpAddressRangeList = new ($homeZoneIpAddressRangeList);
    }
