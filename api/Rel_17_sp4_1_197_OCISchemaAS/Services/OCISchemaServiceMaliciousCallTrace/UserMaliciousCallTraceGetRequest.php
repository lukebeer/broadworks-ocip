 ...
 *         ErrorResponse.
 */
class UserMaliciousCallTraceGetRequest extends ComplexType implements ComplexInterface
{
    public    $responseType = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\Services\OCISchemaServiceMaliciousCallTrace\UserMaliciousCallTraceGetResponse';
    public    $elementName = 'UserMaliciousCallTraceGetRequest';
    protected $userId;
