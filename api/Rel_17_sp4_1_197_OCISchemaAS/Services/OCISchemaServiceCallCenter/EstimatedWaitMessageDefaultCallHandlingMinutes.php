...
/**
 * The default number of call handling minutes.
 */
class EstimatedWaitMessageDefaultCallHandlingMinutes extends SimpleType
{
    public $elementName = "EstimatedWaitMessageDefaultCallHandlingMinutes";
