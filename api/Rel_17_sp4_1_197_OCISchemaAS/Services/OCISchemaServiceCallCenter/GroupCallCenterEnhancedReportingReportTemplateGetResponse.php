...
class GroupCallCenterEnhancedReportingReportTemplateGetResponse extends ComplexType implements ComplexInterface
{
    ...
    public function __construct(
        ...
        $this->xsltTemplateDescription             = new FileDescription($xsltTemplateDescription);
        $this->scope                               = $scope;
    ...
    {
        $xsltTemplateDescription and $this->xsltTemplateDescription = new FileDescription($xsltTemplateDescription);
    }
