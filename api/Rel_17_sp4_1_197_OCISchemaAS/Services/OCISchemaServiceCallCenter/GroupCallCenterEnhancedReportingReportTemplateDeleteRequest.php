 ...
 */
class GroupCallCenterEnhancedReportingReportTemplateDeleteRequest extends ComplexType implements ComplexInterface
{
    public    $elementName = 'GroupCallCenterEnhancedReportingReportTemplateDeleteRequest';
