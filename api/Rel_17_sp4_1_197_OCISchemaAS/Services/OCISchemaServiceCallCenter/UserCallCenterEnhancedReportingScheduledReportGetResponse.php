...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\CallCenterScheduledReportAgentSelectionRead;
...
class UserCallCenterEnhancedReportingScheduledReportGetResponse extends ComplexType implements ComplexInterface
{
    ...
    {
        $agent and $this->agent = new CallCenterScheduledReportAgentSelectionRead($agent);
    }
