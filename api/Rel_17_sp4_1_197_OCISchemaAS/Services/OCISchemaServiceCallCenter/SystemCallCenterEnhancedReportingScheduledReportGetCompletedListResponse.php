...
{
    public    $elementName = 'SystemCallCenterEnhancedReportingScheduledReportGetCompletedListResponse';
    protected $scheduledReportTable;

    /**
     * @return \Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\Services\OCISchemaServiceCallCenter\SystemCallCenterEnhancedReportingScheduledReportGetCompletedListResponse $response
     */
