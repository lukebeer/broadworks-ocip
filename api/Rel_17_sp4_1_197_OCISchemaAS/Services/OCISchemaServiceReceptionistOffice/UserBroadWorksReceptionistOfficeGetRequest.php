 ...
 */
class UserBroadWorksReceptionistOfficeGetRequest extends ComplexType implements ComplexInterface
{
    public    $responseType = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\Services\OCISchemaServiceReceptionistOffice\UserBroadWorksReceptionistOfficeGetResponse';
    public    $elementName = 'UserBroadWorksReceptionistOfficeGetRequest';
    protected $userId;
