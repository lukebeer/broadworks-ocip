 ...
 */
class UserAuthenticationGetRequest extends ComplexType implements ComplexInterface
{
    public    $responseType = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\Services\OCISchemaServiceAuthentication\UserAuthenticationGetResponse';
    public    $elementName = 'UserAuthenticationGetRequest';
    protected $userId;
