...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\CPEDeviceOptionsRead16;
...
class SystemDeviceTypeGetResponse16 extends ComplexType implements ComplexInterface
{
    ...
    {
        $cpeDeviceOptions and $this->cpeDeviceOptions = new CPEDeviceOptionsRead16($cpeDeviceOptions);
    }
