...
class SystemHolidayScheduleModifyRequest extends ComplexType implements ComplexInterface
{
    ...
    public function __construct(
        ...
        $this->newHolidayScheduleName = new ScheduleName($newHolidayScheduleName);
    ...
    {
        $newHolidayScheduleName and $this->newHolidayScheduleName = new ScheduleName($newHolidayScheduleName);
    }
