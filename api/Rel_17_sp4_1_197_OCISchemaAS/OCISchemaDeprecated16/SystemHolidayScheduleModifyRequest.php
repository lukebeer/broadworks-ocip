...
{
    public    $name = 'SystemHolidayScheduleModifyRequest';
    protected $holidayScheduleName;
    protected $newHolidayScheduleName;
    protected $holiday01;
    protected $holiday02;
    protected $holiday03;
    protected $holiday04;
    ...
    public function setNewHolidayScheduleName($newHolidayScheduleName = null)
    {
        ...
        $this->newHolidayScheduleName->setName('newHolidayScheduleName');
        return $this;
    }
    ...
    {
        return ($this->newHolidayScheduleName) ? $this->newHolidayScheduleName->getValue() : null;
    }
