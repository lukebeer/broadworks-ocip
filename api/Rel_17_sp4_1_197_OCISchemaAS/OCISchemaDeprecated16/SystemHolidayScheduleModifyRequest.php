...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDeprecated16\SystemHolidayScheduleModifyResponse;
 ...
 */
class SystemHolidayScheduleModifyRequest extends ComplexType implements ComplexInterface
{
    ...
    public function __construct(
        ...
        $this->setNewHolidayScheduleName($newHolidayScheduleName);
    ...
    /**
     * @return SystemHolidayScheduleModifyResponse
     */
     ...
     * Schedule name.
     */
    public function setNewHolidayScheduleName($newHolidayScheduleName = null)
    {
        $this->newHolidayScheduleName = ($newHolidayScheduleName InstanceOf ScheduleName)
             ? $newHolidayScheduleName
             : new ScheduleName($newHolidayScheduleName);
    }
    ...
    {
        return (!$this->newHolidayScheduleName) ?: $this->newHolidayScheduleName->getValue();
    }
