 ...
 */
class SystemSIPDeviceTypeAddRequest16 extends ComplexType implements ComplexInterface
{
    public    $name = 'SystemSIPDeviceTypeAddRequest16';
    ...
    public function __construct(
         ...
         CPEDeviceOptions16 $cpeDeviceOptions = null,
         $earlyMediaSupport = '',
         $authenticateRefer = '',
     ...
     * 
     */
    public function setCpeDeviceOptions(CPEDeviceOptions16 $cpeDeviceOptions = null)
    {
        $this->cpeDeviceOptions = ($cpeDeviceOptions InstanceOf CPEDeviceOptions16)
             ? $cpeDeviceOptions
             : new CPEDeviceOptions16($cpeDeviceOptions);
    ...
    /**
     * 
     * @return CPEDeviceOptions16 $cpeDeviceOptions
     */
