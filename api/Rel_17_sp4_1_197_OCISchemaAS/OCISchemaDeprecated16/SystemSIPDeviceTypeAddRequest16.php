...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\CPEDeviceOptions16;
...
class SystemSIPDeviceTypeAddRequest16 extends ComplexType implements ComplexInterface
{
    ...
    {
        $cpeDeviceOptions and $this->cpeDeviceOptions = new CPEDeviceOptions16($cpeDeviceOptions);
    }
