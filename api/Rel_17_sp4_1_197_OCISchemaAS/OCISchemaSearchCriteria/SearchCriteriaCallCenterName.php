 ...
 */
class SearchCriteriaCallCenterName extends ComplexType implements ComplexInterface
{
    public    $responseType      = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaSearchCriteria\SearchCriteriaCallCenterName';
    public    $name              = 'SearchCriteriaCallCenterName';
    protected $mode              = null;
    ...
    public function setValue($value = null)
    {
        ...
        $this->value = ($value InstanceOf ServiceInstanceProfileName)
             ? $value
             : new ServiceInstanceProfileName($value);
