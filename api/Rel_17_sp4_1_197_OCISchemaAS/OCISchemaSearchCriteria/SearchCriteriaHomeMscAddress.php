 ...
 */
class SearchCriteriaHomeMscAddress extends ComplexType implements ComplexInterface
{
    public    $responseType      = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaSearchCriteria\SearchCriteriaHomeMscAddress';
    public    $name              = 'SearchCriteriaHomeMscAddress';
    protected $mode              = null;
