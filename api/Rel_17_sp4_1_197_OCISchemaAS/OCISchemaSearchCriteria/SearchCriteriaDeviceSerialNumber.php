...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaSearchCriteria\SearchCriteriaDeviceSerialNumber;
 ...
 */
class SearchCriteriaDeviceSerialNumber extends ComplexType implements ComplexInterface
{
    public    $responseType      = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaSearchCriteria\SearchCriteriaDeviceSerialNumber';
    public    $name              = 'SearchCriteriaDeviceSerialNumber';
    protected $mode              = null;
    ...
    /**
     * @return SearchCriteriaDeviceSerialNumber
     */
    ...
    public function setValue($value = null)
    {
        ...
        $this->value = ($value InstanceOf AccessDeviceSerialNumber)
             ? $value
             : new AccessDeviceSerialNumber($value);
