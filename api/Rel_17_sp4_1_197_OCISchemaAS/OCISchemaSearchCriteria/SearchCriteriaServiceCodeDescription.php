 ...
 */
class SearchCriteriaServiceCodeDescription extends ComplexType implements ComplexInterface
{
    public    $responseType      = 'Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaSearchCriteria\SearchCriteriaServiceCodeDescription';
    public    $name              = 'SearchCriteriaServiceCodeDescription';
    protected $mode              = null;
    ...
    public function setValue($value = null)
    {
        ...
        $this->value = ($value InstanceOf ServiceCodeDescription)
             ? $value
             : new ServiceCodeDescription($value);
