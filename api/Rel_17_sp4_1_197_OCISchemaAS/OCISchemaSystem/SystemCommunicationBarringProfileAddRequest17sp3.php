...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\CommunicationBarringCallMeNowRule;
...
class SystemCommunicationBarringProfileAddRequest17sp3 extends ComplexType implements ComplexInterface
{
    ...
    {
        $callMeNowRule and $this->callMeNowRule = new CommunicationBarringCallMeNowRule($callMeNowRule);
    }
