 ...
 */
class BwDiameterBusyPeerOutstandingTxnCount extends SimpleType
{
    public $elementName = "BwDiameterBusyPeerOutstandingTxnCount";
    public function __construct($value) {
        $this->setElementValue($value);
        $this->addRestriction(new MinInclusive("1"));
        $this->addRestriction(new MaxInclusive("1000000"));
    }
}
