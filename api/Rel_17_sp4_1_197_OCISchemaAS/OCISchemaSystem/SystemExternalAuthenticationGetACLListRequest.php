...
class SystemExternalAuthenticationGetACLListRequest extends ComplexType implements ComplexInterface
{
    ...
    public    $elementName = 'SystemExternalAuthenticationGetACLListRequest';

    public function __construct(    ) {
    }

    /**
     * @return \Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaSystem\SystemExternalAuthenticationGetACLListResponse $response
     */
