...
class SystemFileRepositoryDeviceGetListRequest extends ComplexType implements ComplexInterface
{
    ...
    public    $elementName = 'SystemFileRepositoryDeviceGetListRequest';

    public function __construct(    ) {
    }

    /**
     * @return \Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaSystem\SystemFileRepositoryDeviceGetListResponse $response
     */
