...
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\LocationCriteria;
use Broadworks_OCIP\api\Rel_17_sp4_1_197_OCISchemaAS\OCISchemaDataTypes\RoamingCriteria;
...
class SystemCommunicationBarringCriteriaModifyRequest extends ComplexType implements ComplexInterface
{
    ...
    public function __construct(
        ...
        $this->newName                     = new CommunicationBarringCriteriaName($newName);
    ...
    {
        $newName and $this->newName = new CommunicationBarringCriteriaName($newName);
    }
    ...
    {
        $matchVirtualOnNetCallType and $this->matchVirtualOnNetCallType = new ReplacementVirtualOnNetCallTypeNameList($matchVirtualOnNetCallType);
    }
    ...
    {
        $matchLocation and $this->matchLocation = new LocationCriteria($matchLocation);
    }
    ...
    {
        $matchRoaming and $this->matchRoaming = new RoamingCriteria($matchRoaming);
    }
