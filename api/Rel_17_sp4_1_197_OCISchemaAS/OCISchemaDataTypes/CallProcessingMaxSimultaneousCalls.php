 ...
 */
class CallProcessingMaxSimultaneousCalls extends SimpleType
{
    public $elementName = "CallProcessingMaxSimultaneousCalls";
    public function __construct($value) {
        $this->setElementValue($value);
        $this->addRestriction(new MinInclusive("1"));
        $this->addRestriction(new MaxInclusive("500"));
    }
}
